...
class cache:
    def __init__(self, level): 
        ...
        #0 means no ownership, 1 mean self own, 2 means closer to the cpu level cache own the cache
        self.ownership = [[0 for y in range(self.ways)] for x in range(1 << self.line_size)]
...
#        self.ownership[self.index(addr)][write_way] = 1
